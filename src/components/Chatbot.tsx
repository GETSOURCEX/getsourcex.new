...
>
  ...
  <div className="absolute bottom-full right-0 mb-2 px-3 py-1 bg-gray-900 text-white text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap">
    Chat with Maya
      ...
      {open && (
        <div
          ...
          style={{
            fontFamily: "'Inter', 'Plus Jakarta Sans', 'Manrope', system-ui, sans-serif",
          }}
        >
          {/* Header */}
    ...
    <form
      onSubmit={(e) => {
        e.preventDefault(); // prevents accidental auto-submit
            ...
            <>
              ...
              >
                {messages.map((msg) => (
                  <div
                    key={msg.id}
                    className={`flex ${msg.sender === 'user' ? 'justify-end' : 'justify-start'} items-start gap-3 animate-in slide-in-from-bottom-2 duration-300`}
                  >
                    {msg.sender === 'bot' && (
                      <img
                        src={MayaAvatar}
